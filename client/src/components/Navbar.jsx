...
const Navbar = ({ openLog, setOpenLog, editLog }) => {
  ...
  return (
    <>
      <nav className={`navbar fixed top-0 left-0 w-full flex items-center justify-between bg-white px-3 lg:px-10 py-5 shadow-md rounded-b-xl z-50 ${editLog ? "blur-sm" : ""} ${openLog ? "blur-sm" : ""}`}>
